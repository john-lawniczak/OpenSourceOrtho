...
public enum SafetyText {
    ...
    OpenSource Ortho is a treatment-planning research toolkit. The current build \
    is not distributed as a medical device and does not diagnose, treat, or \
    approve treatment. A CONSISTENT verdict means the staging is internally \
    consistent with the configured caps and controls - not that it is safe, \
    approved, or clinically appropriate. Always consult a licensed dental \
    professional.
    """
